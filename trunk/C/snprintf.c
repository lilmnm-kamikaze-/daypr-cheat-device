...
/* Define HAVE_SNPRINTF if your system already has snprintf.
 *
 * If HAVE_SNPRINTF is defined this module will produce no code
 * unless PREFER_PORTABLE_SNPRINTF is defined as well,
 * causing portable version of snprintf to be called portable_snprintf.
 */
/* #define HAVE_SNPRINTF */

/* Define PREFER_PORTABLE_SNPRINTF if your system does have snprintf
 * but you would prefer to use this portable routine instead.
 * In this case the portable routine is declared as portable_snprintf
 * and a macro 'snprintf' is defined to expand to 'portable_snprintf'
 * - see file snprintf.h .
 * Defining this macro if HAVE_SNPRINTF is *not* defined does no harm.
 */
 ...
 * specifically required, this module produces no code.
 */
...
/* prototype */
int /*portable_*/snprintf(char *str, size_t str_m, const char *fmt, /*args*/ ...);
